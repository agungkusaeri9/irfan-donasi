                    ...
                    <div class="card-body">
                            @if (session('resent'))
                                <div class="alert alert-success" role="alert">
                                    Kami telah mengirimkan link verifikasi baru ke email anda.
                                </div>
                            @endif

                           <p>Silahkan cek email anda untuk proses verifikasi dan klik link yang kami berikan. Jika tidak menerima email, silahkan klik kirim ulang.</p>
