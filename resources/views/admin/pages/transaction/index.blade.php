                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-12">
                                  <div class="text-center">
                                    ...
                                    <button class="btn mb-1 btn-danger btnAction" type="button" data-name="print"><i class="fas fa-file-pdf"></i>
                                        Print</button>
                                    @endcan

                                   @can('Transaction Export')
                                   <button class="btn mb-1 btn-primary btnAction" type="button" data-name="export"><i class="fas fa-file-excel"></i>
                                    Export</button>
                                   @endcan
                                  </div>
                                </div>
