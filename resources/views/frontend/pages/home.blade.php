    ...
    <div class="counter">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ asset('assets/frontend/images/details-2.svg') }}" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="grid">
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('assets/frontend/images/project-1.jpg')}}" alt="alternative">
                        ...
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('assets/frontend/images/project-2.jpg')}}" alt="alternative">
                        ...
                        <div class="element-item development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('assets/frontend/images/project-3.jpg')}}" alt="alternative">
                        ...
                        <div class="element-item design development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('assets/frontend/images/project-4.jpg')}}" alt="alternative">
                        ...
                        <div class="element-item design development">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('assets/frontend/images/project-5.jpg')}}" alt="alternative">
                        ...
                        <div class="element-item design marketing">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('assets/frontend/images/project-6.jpg')}}" alt="alternative">
                        ...
                        <div class="element-item design marketing">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('assets/frontend/images/project-7.jpg')}}" alt="alternative">
                        ...
                        <div class="element-item design marketing">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('assets/frontend/images/project-8.jpg')}}" alt="alternative">
                        ...
                        <div class="element-item design marketing">
                            <a href="article.html">
                                <img class="img-fluid" src="{{ asset('assets/frontend/images/project-9.jpg')}}" alt="alternative">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="details">
                                                <img class="testimonial-image" src="{{ asset('assets/frontend/images/testimonial-1.jpg')}}"
                                                    alt="alternative">
                                                <div class="text">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="details">
                                                <img class="testimonial-image" src="{{ asset('assets/frontend/images/testimonial-2.jpg')}}"
                                                    alt="alternative">
                                                <div class="text">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="details">
                                                <img class="testimonial-image" src="{{ asset('assets/frontend/images/testimonial-3.jpg')}}"
                                                    alt="alternative">
                                                <div class="text">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="details">
                                                <img class="testimonial-image" src="{{ asset('assets/frontend/images/testimonial-4.jpg')}}"
                                                    alt="alternative">
                                                <div class="text">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <img class="decoration-lines" src="{{ asset('assets/frontend/images/decoration-lines.svg') }}"
                                    alt="alternative"><span>Landing page</span><img class="decoration-lines flipped"
                                    src="{{ asset('assets/frontend/images/decoration-lines.svg') }}" alt="alternative">
                            </div>
                            <ul class="list-unstyled li-space-lg">
